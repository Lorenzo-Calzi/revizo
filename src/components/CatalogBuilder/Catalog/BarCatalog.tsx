...
export default function BarCatalog({
    business,
    categories,
    items,
    onAddCategory,
    ...
    return (
        <section className={styles.catalog}>
            <Text variant="title-lg">Menu Bar</Text>
                ...
                {categories.map(cat => (
                    <li key={cat.id} className={styles.categoryCard}>
                        ...
                        <div className={styles.itemsList}>
                            ...
                            <AddBarItemForm
                                placeholder={`Aggiungi drink a "${cat.name}"`}
...
// ═══════════════════════════════════════════════════
// ITEM CARD (Bar) – UI semplice, niente allergeni
// ═══════════════════════════════════════════════════
...
function BarItemCard({
    ...
    const handleBlurDescription = () => {
        if (localDescription !== (item.description ?? "")) {
            void onUpdate(item.id, categoryId, { description: localDescription || null });
        }
    };
...
const MemoizedBarItemCard = React.memo(BarItemCard);

// ═══════════════════════════════════════════════════
// Add item form (bar)
// ═══════════════════════════════════════════════════

function AddBarItemForm({
    placeholder,
    onAdd
}: {
    placeholder: string;
